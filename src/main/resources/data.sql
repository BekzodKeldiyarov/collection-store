insert into usr (email, is_enabled, password, username)
values ('sdeandreis0@ucoz.ru', true, 'dRHPrrWx45LX', 'pcreevy0');
insert into usr (email, is_enabled, password, username)
values ('bcovey1@amazonaws.com', true, '9Qd9T2ey7TLi', 'ckerne1');
insert into usr (email, is_enabled, password, username)
values ('pglasspool2@people.com.cn', false, 'UwF5wuYtN7m', 'lgallant2');
insert into usr (email, is_enabled, password, username)
values ('wbidgood3@yellowbook.com', true, 'XfkpjDlE', 'dcherm3');
insert into usr (email, is_enabled, password, username)
values ('ncrutchfield4@rediff.com', false, '4EIslie59d', 'jmugleston4');
insert into usr (email, is_enabled, password, username)
values ('thare5@bbb.org', false, 'D7qv0aL', 'gtreadgold5');
insert into usr (email, is_enabled, password, username)
values ('dhighway6@usa.gov', true, 'WWg2HpgPs', 'mgronaller6');
insert into usr (email, is_enabled, password, username)
values ('cbrugger7@utexas.edu', false, 'W5vKtLDITjc', 'dcharlotte7');
insert into usr (email, is_enabled, password, username)
values ('scaught8@fotki.com', false, 'QzuQOZUCEa0m', 'aferrao8');
insert into usr (email, is_enabled, password, username)
values ('gdemsey9@vk.com', true, 'EGSQis9', 'vsindle9');
...
insert into collection (name, description, user_id)
values ('Lotstring',
        'diam neque vestibulum eget vulputate ut ultrices vel augue vestibulum ante',
        2);
insert into collection (name, description, user_id)
values ('Bitwolf',
...
values ('Flowdesk',
        ...
        4);
insert into collection (name, description, user_id)
values ('Keylex', 'pede malesuada in imperdiet et commodo vulputate justo in blandit ultrices enim lorem ipsum', 4);
insert into collection (name, description, user_id)
values ('Sonsing',
...
values ('Voyatouch',
        ...
        5);
insert into collection (name, description, user_id)
values ('Domainer', 'vulputate elementum nullam varius nulla facilisi cras non velit nec', 1);
insert into collection (name, description, user_id)
values ('Flowdesk',
...
insert into collection (name, description, user_id)
values ('Toughjoyfax',
        'vel sem sed sagittis nam congue risus semper porta volutpat quam pede lobortis ligula sit amet eleifend pede libero quis orci nullam molestie nibh in lectus pellentesque at nulla suspendisse potenti cras in',
        9);

insert into item (name, collection_id) values ('success', 20);
insert into item (name, collection_id) values ('Streamlined', 4);
insert into item (name, collection_id) values ('grid-enabled', 12);
insert into item (name, collection_id) values ('coherent', 13);
insert into item (name, collection_id) values ('Future-proofed', 3);
insert into item (name, collection_id) values ('local', 16);
insert into item (name, collection_id) values ('matrix', 8);
insert into item (name, collection_id) values ('hub', 16);
insert into item (name, collection_id) values ('Polarised', 5);
insert into item (name, collection_id) values ('5th generation', 3);
insert into item (name, collection_id) values ('service-desk', 5);
insert into item (name, collection_id) values ('open architecture', 3);
insert into item (name, collection_id) values ('Right-sized', 20);
insert into item (name, collection_id) values ('high-level', 20);
insert into item (name, collection_id) values ('bottom-line', 20);
insert into item (name, collection_id) values ('non-volatile', 5);
insert into item (name, collection_id) values ('Devolved', 3);
insert into item (name, collection_id) values ('productivity', 7);
insert into item (name, collection_id) values ('throughput', 18);
insert into item (name, collection_id) values ('logistical', 18);
